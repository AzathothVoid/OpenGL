...
float xvalue = 0.5;
float yvalue = -0.5;
glm::vec3 zvalue = glm::vec3(1.0f, 1.0f, 1.0f);
...
int main() {
	...
	while (!glfwWindowShouldClose(window)) {
		...
		trans = glm::translate(trans, glm::vec3(xvalue, yvalue, 0.0f));
		trans = glm::rotate(trans, glm::radians(angle), glm::vec3(1.0f, 1.0f, 1.0f));
		trans = glm::scale(trans, zvalue);
